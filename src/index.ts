...
try {
  ...
  // Create a temp working dir and write a certificate to file
  ...
  if (!match) {
    core.warning('No matching identity found.');
  ...
  core.setSecret(certId);
  core.setSecret(match);
